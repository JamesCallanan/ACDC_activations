...
def unet2D_bn_modified(images, training, nlabels):
    ...
    #all the num_filters=4 below can be replaced with num_filters=nlabels
    upconv4 = layers.deconv2D_layer_bn(conv5_2, name='upconv4', kernel_size=(4, 4), strides=(2, 2), num_filters=4, training=training)
    #?
    ...
    upconv3 = layers.deconv2D_layer_bn(conv6_2, name='upconv3', kernel_size=(4, 4), strides=(2, 2), num_filters=4, training=training)
    ...
    upconv2 = layers.deconv2D_layer_bn(conv7_2, name='upconv2', kernel_size=(4, 4), strides=(2, 2), num_filters=4, training=training)
    ...
    upconv1 = layers.deconv2D_layer_bn(conv8_2, name='upconv1', kernel_size=(4, 4), strides=(2, 2), num_filters=4, training=training)
    ...
    pred = layers.conv2D_layer_bn(conv9_2, 'pred', num_filters=4, kernel_size=(1,1), activation=tf.identity, training=training, padding='VALID')
    #?
    return pred, conv5_2
